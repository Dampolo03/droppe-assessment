...
export const getGrouppedArray = (data: any) => {
...
export const getEachProductCount = (data: any) => {
  const eachCounts = Object.values(
    data?.reduce((c: any, { productId }: any) => {
...
export const getGroupedQuantities = (data: any) => {
  const keys = ["quantity"],
    groupedQuantities = Object.values(
      data?.reduce((result: any, object: any) => {
